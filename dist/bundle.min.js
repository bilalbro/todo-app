(function () {
	...
	var LS_TODO_TASKS_KEY = 'todoTasks';
	var TaskManager = /*#__PURE__*/function () {
	  ...
	  _createClass(TaskManager, [{
	    ...
	    key: "updateTasksLocalStorage",
	    value: function updateTasksLocalStorage() {
	      localStorage.setItem(LS_TODO_TASKS_KEY, JSON.stringify(this.tasks));
	    }
	  }, {
	    key: "getTasks",
	    value: function getTasks() {
	      return _toConsumableArray(this.tasks);
	    }
	  }, {
	    key: "addTask",
	    ...
	    key: "indexOfTask",
	    value: function indexOfTask(taskId) {
	    ...
	    key: "updateTask",
	    value: function updateTask(taskId, taskName) {
	...
	var AddTaskForm = function AddTaskForm(_ref) {
	  ...
	  }), /*#__PURE__*/React.createElement("button", null, /*#__PURE__*/React.createElement(FaPlus, null))), /*#__PURE__*/React.createElement("div", {
	    className: "add-task-form_msg"
	  }, /*#__PURE__*/React.createElement(FaExclamationTriangle, null), " Field can't be empty!"));
	};

	var InputCheckbox = function InputCheckbox(_ref) {
	  var checked = _ref.checked,
	    _onChange = _ref.onChange;
	  var _useState = react.exports.useState(checked),
	    _useState2 = _slicedToArray(_useState, 2),
	    localChecked = _useState2[0],
	    setLocalChecked = _useState2[1];
	  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", null, /*#__PURE__*/React.createElement("input", {
	    type: "checkbox",
	  ...
	  }, checked && /*#__PURE__*/React.createElement(FaCheck, null))));
	};
	...
	var Task = function Task(_ref) {
	  var name = _ref.name,
	    ...
	    onCompletionToggle = _ref.onCompletionToggle,
	    bringingUp = _ref.bringingUp,
	    hiding = _ref.hiding,
	    bringingDown = _ref.bringingDown,
	    showing = _ref.showing;
	  var _useState = react.exports.useState(false),
	    _useState2 = _slicedToArray(_useState, 2),
	    isUpdating = _useState2[0],
	    setIsUpdating = _useState2[1];
	  var _useState3 = react.exports.useState(name),
	    _useState4 = _slicedToArray(_useState3, 2),
	    updatedName = _useState4[0],
	    setUpdatedName = _useState4[1];
	  var nameInputElement = react.exports.useRef();
	  var wasMouseDown = react.exports.useRef(false);
	  ...
	  return /*#__PURE__*/React.createElement("li", {
	    ...
	    onChange: function onChange(e) {
	      return setUpdatedName(e.target.value);
	    }
	  }), isUpdating ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
	    className: "task_btn task_btn--last",
	    key: 0,
	    onMouseDown: onDoneButtonFocus
	  }, /*#__PURE__*/React.createElement(FaCheck, null))) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
	    className: "task_btn task_btn--second-last",
	    key: 1,
	    ...
	    type: "button"
	  }, /*#__PURE__*/React.createElement(FaTrash, null)))));
	};
	var PureTask = /*#__PURE__*/react.exports.memo(Task);

	var TodoList = function TodoList(_ref) {
	  var tasks = _ref.tasks,
	    onRemoveTask = _ref.onRemoveTask,
	    onUpdateTask = _ref.onUpdateTask,
	    onTaskCompletionToggle = _ref.onTaskCompletionToggle,
	    removeIndex = _ref.removeIndex,
	    addingTask = _ref.addingTask,
	    clearingTasks = _ref.clearingTasks;
	  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("ol", {
	    className: "tasks-list"
	  }, tasks.map(function (task, i) {
	    return /*#__PURE__*/React.createElement(PureTask, _extends({
	      showing: addingTask & i === 0,
	      bringingDown: addingTask && i !== 0,
	      hiding: i === removeIndex || clearingTasks,
	      bringingUp: i > removeIndex,
	      key: task.id,
	...
	var UPDATE_TASKS_DELAY = 300;
	var taskManager = new TaskManager();
	function useTasks() {
	  var _useState = react.exports.useState(taskManager.getTasks()),
	    _useState2 = _slicedToArray(_useState, 2),
	    tasks = _useState2[0],
	    setTasks = _useState2[1];
	  return [tasks, function () {
	    return setTasks(taskManager.getTasks());
	  }];
	}
	var App = function App() {
	  var _useTasks = useTasks(),
	    _useTasks2 = _slicedToArray(_useTasks, 2),
	    tasks = _useTasks2[0],
	    updateTasks = _useTasks2[1];
	  var removeIndex = react.exports.useRef(Infinity);
	  var addingTask = react.exports.useRef(false);
	  var clearingTasks = react.exports.useRef(false);
	  ...
	  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h1", null, "Let's Do To-do!"), /*#__PURE__*/React.createElement("footer", null, "Made by ", /*#__PURE__*/React.createElement("a", {
	    href: "https://github.com/bilalbro"
	  }, "@bilalbro"), " using React, Vanilla CSS, and Rollup.js"), /*#__PURE__*/React.createElement(AddTaskForm, {
	    onAddTask: onAddTask
	  }), /*#__PURE__*/React.createElement(TodoList, {
	    removeIndex: removeIndex.current,
	    addingTask: addingTask.current,
	    clearingTasks: clearingTasks.current,
	    onRemoveTask: onRemoveTask,
	    onTaskCompletionToggle: onTaskCompletionToggle,
	    onUpdateTask: onUpdateTask,
	    tasks: tasks
	  }), !clearingTasks.current && tasks.length !== 0 && /*#__PURE__*/React.createElement("div", {
	    className: classNames({
	      'clear-btn': true,
	  ...
	  }, /*#__PURE__*/React.createElement(FaTimes, null), " Clear all")));
	};
